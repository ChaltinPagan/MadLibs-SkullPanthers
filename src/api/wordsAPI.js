...
let randNoun = () =>
  wordsAPI.nouns[Math.floor(Math.random() * wordsAPI.nouns.length)];
let randName = () =>
  wordsAPI.names[Math.floor(Math.random() * wordsAPI.names.length)];
let randAdj = () => adjectives[Math.floor(Math.random() * adjectives.length)];
let randAdv = () =>
  wordsAPI.adverb[Math.floor(Math.random() * wordsAPI.adverb.length)];
let randPlural = () =>
